 ...
 */
public class MedicalStaffPayroll implements Payroll {
    ...
    public PayrollModel calculatePayroll(int daysWorkedInAMonth, int degree) {
        BigDecimal payroll = BigDecimal.valueOf(Long.parseLong(String.valueOf(daysWorkedInAMonth)))
                ...
                .multiply(StaffConstants.medicalStaffConstant)
    ...
    public void showGeneratedPayroll(PayrollModel payrollModel) {
        System.out.println("Payroll of " + payrollModel.getDaysWorkedInAMonth() + " days worked medical staff from " + payrollModel.getDegree() + ". degree amount is : " + payrollModel.getAmount());
    }
}
